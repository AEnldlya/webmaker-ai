      ...
      <div className="max-w-md w-full">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-warm-gray-900 font-serif">Create account</h1>
            <p className="text-warm-gray-600 mt-2">Start building websites today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-warm-gray-400" />
                <input
                  type="text"
                  value={name}
